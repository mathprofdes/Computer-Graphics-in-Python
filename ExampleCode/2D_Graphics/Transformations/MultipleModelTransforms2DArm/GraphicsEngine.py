...
# using a series of rotations and translations.
#
# Don Spickler
# 12/9/2021
...
class GraphicsEngine():
    ...
    def __init__(self):
        ...
        self.arms = [LineSegment2D(0.5, [1, 0, 0]),
                     LineSegment2D(0.35, [0, 1, 0]),
                     LineSegment2D(0.25, [0, 0, 1]),
                     ]
    ...
    def update(self):
        ...
        for i in range(len(self.arms)):
            ...
            ModelMatrix = ModelMatrix * glm.translate(glm.vec3(self.arms[i].getLength(), 0, 0))
