...
class GraphicsEngine():
    ...
    def update(self):
        ...
        TotalTransMatrix = self.ProjectionMatrix * ScaleMatrix
        glUniformMatrix4fv(self.PM_Loc, 1, GL_FALSE, glm.value_ptr(TotalTransMatrix))
        self.box.draw()
        ...
        TotalTransMatrix = self.ProjectionMatrix * RotateMatrix * TranslateMatrix * ScaleMatrix
        glUniformMatrix4fv(self.PM_Loc, 1, GL_FALSE, glm.value_ptr(TotalTransMatrix))
        self.box.draw()
        ...
        TotalTransMatrix = self.ProjectionMatrix * TranslateMatrix * RotateMatrix * ScaleMatrix
        glUniformMatrix4fv(self.PM_Loc, 1, GL_FALSE, glm.value_ptr(TotalTransMatrix))
        self.box.draw()
