...
class GraphicsEngine():
    ...
    def __init__(self):
        ...
        self.spotdirectioncamera = SphericalCamera(1, 135, -45)
        self.light.spotCutoff = 20
    ...
    def update(self):
        ...
        self.light.spotDirection = self.spotdirectioncamera.getPosition() - self.lightcamera.getPosition()
        self.light.LoadLight(self.LightingShader, "Lt")
