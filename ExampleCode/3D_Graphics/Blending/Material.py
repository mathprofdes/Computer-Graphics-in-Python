...
class Material():
    ...
    def RedPlasticST(self):
        self.ambient = glm.vec4(0.3, 0, 0, 0)
        self.diffuse = glm.vec4(0.6, 0, 0, 0.5)
        self.specular = glm.vec4(0.8, 0.6, 0.6, 0)
        self.emission = glm.vec4(0, 0, 0, 0)
        self.shininess = 32

    def GreenPlasticST(self):
        self.ambient = glm.vec4(0, 0.3, 0, 0)
        self.diffuse = glm.vec4(0, 0.6, 0, 0.5)
        self.specular = glm.vec4(0.6, 0.8, 0.6, 0)
        self.emission = glm.vec4(0, 0, 0, 0)
        self.shininess = 32

    def BluePlasticST(self):
        self.ambient = glm.vec4(0, 0, 0.3, 0)
        self.diffuse = glm.vec4(0, 0, 0.6, 0.5)
        self.specular = glm.vec4(0.6, 0.6, 0.8, 0)
        self.emission = glm.vec4(0, 0, 0, 0)
        self.shininess = 32
