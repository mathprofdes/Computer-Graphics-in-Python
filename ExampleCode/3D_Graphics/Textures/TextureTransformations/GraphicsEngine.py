...
class GraphicsEngine():
    ...
    def __init__(self):
        ...
        try:
            ...
            self.TextureShader = shader.loadShadersFromFile("Shaders/VertexShaderBasic3DTexture.glsl",
                                                            "Shaders/SimpleTextureTrans.glsl")
        ...
        self.texMatLocRender = glGetUniformLocation(self.TextureShader, "TexMat")
    ...
    def update(self):
        ...
        textureMat = glm.scale(glm.vec3(5))
        ...
        # textureMat = glm.rotate(glm.radians(self.a), glm.vec3(0, 0, 1))

        # textureMat = glm.translate(glm.vec3(self.a/100, 0, 0))

        # textureMat = glm.scale(glm.vec3(glm.sin(self.a/100)))
        # textureMat = glm.rotate(textureMat, glm.radians(self.a), glm.vec3(0, 0, 1))

        # Load Texture matrix.  Note that if this is not dynamic it can be loaded outside the update.
        glUniformMatrix4fv(self.texMatLocRender, 1, GL_FALSE, glm.value_ptr(textureMat))
