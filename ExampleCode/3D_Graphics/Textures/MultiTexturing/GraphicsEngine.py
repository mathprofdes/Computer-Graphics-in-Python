...
class GraphicsEngine():
    ...
    def __init__(self):
        ...
        self.texID3 = self.loadTexture("Images/Repeat-brick.jpg")

        glUniform1i(glGetUniformLocation(self.TextureShader, "tex1"), 0)  # GL_TEXTURE0
        glUniform1i(glGetUniformLocation(self.TextureShader, "tex2"), 1)  # GL_TEXTURE1
    ...
    def update(self):
        ...
        model = glm.translate(glm.vec3(5, 0, 0))
        model = glm.scale(model, glm.vec3(5))
        self.loadModelMatrix(model)
        self.cube.draw()

        # Set textures for sphere.
        glActiveTexture(GL_TEXTURE0)
        ...
        model = glm.translate(glm.vec3(0, 5, 0))
        model = glm.scale(model, glm.vec3(3))
        self.loadModelMatrix(model)
        self.torus.draw()
