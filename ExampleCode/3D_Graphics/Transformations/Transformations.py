#! /usr/bin/env python3
#
# This program is a demo program for the basic setup and experimentation
# of 3-D OpenGL transformations of simple objects.
#
# The initial screen will render the coordinate axes and a a single multi-colored
# cubes along with the same cube under a set of basic transformations.  The
...
ProgramName = "3-D Transformations"
maxfps = 60
minMajor = 3
minMinor = 3
Width = 800
